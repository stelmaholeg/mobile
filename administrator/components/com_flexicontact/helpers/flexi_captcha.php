...
// draw the chosen images
	...
	foreach ($captcha_info->images as $index => $image)
		...
		$src = 'index.php?option='.LAFC_COMPONENT.'&amp;tmpl=component&amp;task=image&amp;n='.$index.'&amp;r='.rand();
		$imageHtml = '<img id="i_'.$img_id.'" name="fc_image" src="'.$src.'" width="'.$image_width.'" height="'.$image_height.'" 
