...
<table class="admintable" summary="<?php echo JText::_('COM_VIRTUEMART_RATING_EDIT_TITLE');?>">
	...
	<tr>
		...
		<td width="76%" align="left">
			<!--<textarea onblur="refresh_counter();" onfocus="refresh_counter();" onkeypress="refresh_counter();" rows="20" cols="60" name="comment">
                <?php echo $this->rating->comment; ?>
            </textarea>-->
		</td>
	</tr>
	<tr>
...
function refresh_counter() {
    ...
    form.counter.value = 150; /* form.comment.value.length; */
}
refresh_counter();
