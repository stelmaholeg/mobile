 ...
 * @version $Id: default_shopfront.php 5859 2012-04-13 06:23:37Z electrocity $
 */
...
<?php		$options = array(
			...
			?>
			 <div style="font-weight:bold;">
					...
					<img style="border:0" id="imagelib" alt="<?php echo JText::_('COM_VIRTUEMART_PREVIEW'); ?>" name="imagelib" src="<?php if ($this->config->get('rised_availability')) echo JURI::root(true).$this->imagePath.$this->config->get('rised_availability');?>"/>
			</fieldset></td>
			</tr>
				<tr>
	    	<td class="key">
