	...
	<tr>
		<td width="50%">
			<table class="adminform">
				...
				<tr>
					<td width="21%">&nbsp;</td>
					<td width="79%"><img style="border:0" id="imagelib" alt="<?php echo JText::_('COM_VIRTUEMART_PREVIEW'); ?>" name="imagelib" src="<?php if ($this->product->product_availability) echo JURI::root(true).$this->imagePath.$this->product->product_availability;?>"/></td>
				</tr>
