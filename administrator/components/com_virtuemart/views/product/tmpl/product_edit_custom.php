			...
			<fieldset style="background-color:#F9F9F9;">
				...
				<table id="custom_fields" class="adminlist" cellspacing="0" cellpadding="0">
					...
					<tr class="row1">
                        ...
                        <th><?php echo JText::_('is_on_common_tab');?></th>
                        <th><?php echo JText::_('is_on_fullinfo_tab');?></th>
                        <th><?php echo JText::_('is_on_filterlist');?></th>
                        <th><?php echo JText::_('filter_order_num');?></th>
                        <th><?php echo JText::_('is_group_name');?></th>
