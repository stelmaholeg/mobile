 ...
 */
class FavoritesViewFavorites extends JView
{
	...
	**/
	public function getProductList()
    {
        ...
        $query = 'SELECT prod.virtuemart_product_id, prod_lng.product_name from `#__virtuemart_products` prod, `#__virtuemart_products_en_gb` prod_lng WHERE prod.published = "1" AND prod.virtuemart_product_id = prod_lng.virtuemart_product_id ORDER BY prod_lng.product_name ASC';
