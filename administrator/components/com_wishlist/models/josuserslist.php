 ...
 */
class FavoritesModelJosuserslist extends JModel{
	/**
	...
	*/
	...
	private function _buildQueryOrderBy() {
	    ...
	    $allowedOrders = explode(',', 'id,name,username,email,password,usertype,block,sendEmail,gid,registerDate,lastvisitDate,activation,params'); // array('id', 'ordering', 'published'); 
	...
	private function _buildQueryWhere() {
		...
		$allowedSearch = explode(',', 'id,name,username,email,usertype'); // array('id', 'ordering', 'published'); 
		$where = ' WHERE (0=1) ';
