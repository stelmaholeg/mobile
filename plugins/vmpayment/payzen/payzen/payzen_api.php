...
class VadsApi {
	...
	*/
	...
	/**
	 * Public static method to compute a vads signature. Parameters must be in utf-8.
	...
	function getOutputForGateway($case = '', $extraMessage = "") {
		...
		$cases = array(
				...
				'payment_ok_already_done' => array(
						true,
						'Paiement valide traité, déjà enregistré'),
				'order_not_found' => array(false, 'Impossible de retrouver la commande'),
				'payment_ko_on_order_ok' => array(
						false,
						'Code paiement invalide reçu pour une commande déjà validée'),
