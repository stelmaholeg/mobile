...
// 		$params = new JParameter($payment->payment_params);
    ...
    $details_url = juri::root().'index.php?option=com_virtuemart&view=orders&layout=details&tmpl=component&order_pass='.$order['details']['BT']->order_pass.'&order_number='.$order['details']['BT']->order_number;
    $printhref = '<a href="javascript:void window.open(\''.$details_url.'\', \'win2\', \'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no\');">распечатать</a>';

    $html .= "<tr><td>Товарный чек</td><td>".$printhref."</td></tr>";
        $html .= '</table>' . "\n";
