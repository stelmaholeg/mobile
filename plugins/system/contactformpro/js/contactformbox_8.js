...
(function($) {
    ...
    container,
    bottom,
    mainForm,    // Have you ever worn the mask one-two one-two
    theMask;     // http://www.youtube.com/watch?v=O3F0YcnVhRs
    ...
    window.addEvent("domready", function() {
        ...
        theMask = new Mask(document.body, {
            hideOnClick: true,
            'class': 'cfp_mask',
            onHide: function(){
                ContactFormBox.close();
            }
        });
