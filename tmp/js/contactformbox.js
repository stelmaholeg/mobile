...
(function($) {
    ...
    function startEffect() {
        ...
        mediaWidth = container.offsetWidth + center.getStyle('padding-left').toInt() + center.getStyle('padding-right').toInt();
        mediaHeight = container.offsetHeight + center.getStyle('padding-top').toInt() + center.getStyle('padding-bottom').toInt();
