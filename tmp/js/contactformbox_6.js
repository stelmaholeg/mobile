...
(function() {
 ...
 var defaultOptions;
    ...
    // DOM elements
    overlay, center, message_div, container_out, container_in, style, status, bottom,
    ...
    window.addEvent("domready", function() {
        ...
        /*
        container_in = new Element("div", {
                    "class": "inner2"
            }).inject(
                new Element("div", {
                    "class": "inner1"
            }).inject(
                container_out = new Element("div", {
    ...
    ContactFormBox = {
        ...
        recenter: function(){	// Thanks to Garo Hussenjian (Xapnet Productions http://www.xapnet.com) for suggesting this addition
            ...
            if (center && !Browser.Platform.ios) {
                ...
                center.setStyles({
                    left: left,
                    marginLeft: -(container_out.offsetWidth/2)-margin
                });
        ...
        open: function(_media, _options) {
            ...
            if(typeof style != 'undefined'){
                ...
                container_out.removeClass(style);
            }
...
/*
    ...
    function startEffect() {
        ...
        mediaWidth = container_in.offsetWidth;
        mediaHeight = container_in.offsetHeight;
