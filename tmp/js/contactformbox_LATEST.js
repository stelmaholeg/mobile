...
(function($) {
    ...
    ContactFormBox = {
        ajax: function(_url, _options) {
            ...
            mainForm = new Element('div').setStyle('display', 'none');
            new Request.HTML({
                url: _url,
                data: options,
                onSuccess: function(responseTree){
                    mainForm.adopt(responseTree);
                    return ContactFormBox.open(mainForm, false);
                }
            }).send();
        },
    ...
    function setup(open) {
        ...
        window[fn]("resize", ContactFormBox.onResize);
    ...
    function startEffect() {
        ...
        var marginLeft = center.getStyle('padding-left').toInt()+container.getStyle('margin-left').toInt(),
        ...
        mediaHeight = mediaHeight ? mediaHeight : container.scrollHeight + center.getStyle('padding-top').toInt();
