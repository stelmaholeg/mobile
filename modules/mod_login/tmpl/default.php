...
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" >
    ...
    <script type="text/javascript">
        function makered(el){
            ...
            jQuery(el).parent().find("#modlgn-passwd").attr('style','border:solid 1px #F90000 !important');
        }
        function makegreen(el){
            jQuery(el).parent().find("#modlgn-username").attr('style','border:solid 1px #00F900 !important');
            jQuery(el).parent().find("#modlgn-passwd").attr('style','border:solid 1px #00F900 !important');
        }
