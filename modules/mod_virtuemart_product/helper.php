...
class mod_virtuemart_product {
    ...
    public function addtocartshort($product,$class,$title) {
        if (!VmConfig::get('use_as_catalog',0)) { ?>
            <form method="post" class="product" action="index.php">
                ...
                ?>
				<input type="submit" name="addtocart" class="<?php echo $class ?>" value="<?php echo $title ?>" title="<?php echo $title ?>" />
	...
	function addtocart($product, $btn_label = null) {
            if (!VmConfig::get('use_as_catalog',0)) { ?>
...
// Display the add to cart button
            ...
            if($btn_label){
                $button_lbl = $btn_label;
            }
			?>
			<?php // Display the add to cart button ?>
			<!--<span class="addtocart-button">-->
				<input type="submit" name="addtocart"  class="addtocart-button" value="<?php echo $button_lbl ?>" title="<?php echo $button_lbl ?>" style="display:inline-block; padding-bottom:2px;" />
			<!--</span>-->
                        <!--<div class="clear"></div>-->
                    </div>
                    <input type="hidden" class="pname" value="<?php echo $product->product_name ?>"/>
