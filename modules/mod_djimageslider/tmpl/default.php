...
defined('_JEXEC') or die ('Restricted access'); ?>
    ...
    <div id="cust-navigation">
        <div id="cust-navigation<?php echo $mid; ?>" class="navigation-container-custom">
            <li>
            <?php $i = 0; foreach ($slides as $slide) { ?>
            <img class="load-button<?php if ($i == 0) echo ' load-button-active'; ?>" src="<?php echo $slide->image; ?>" alt="<?php echo $slide->alt; ?>" style="width:150px; height:74px; border:solid 1px #eeeeee; margin-right:16px;" />
            <?php $i++; if($i>3){$i=0; echo "</li><li>"; } } ?>
            </li>
        </div>
        <div id="custom-nav-arrow-back" style="float:left; font-size:18px; width:20px; height:40px;"></div>
        <div id="custom-nav-arrow-forward" style="float:right; font-size:18px; width:20px; height:40px;"></div>
    </div>
    <?php } ?>