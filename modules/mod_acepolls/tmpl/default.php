...
<?php for ($i = 0, $n = count($options); $i < $n; $i ++) { ?>
	<!--label for="mod_voteid<?php //echo $options[$i]->id;?>" class="<?php //echo// $tabclass_arr[$tabcnt].$params->get('moduleclass_sfx'); ?>" style="display:block; padding:2px;margin-bottom:7px;cursor:pointer;"-->    
     <div>
        <div class="radio" ></div>
...
<!--<script type="text/javascript">
    jQuery(document).ready(function(){
		...
		jQuery('#poll_vote_1 label').click(function(){
			jQuery('.radio').removeClass('active');
