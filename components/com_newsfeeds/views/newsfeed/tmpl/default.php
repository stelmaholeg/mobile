...
<?php endif; ?>
	<h2 class="<?php echo $direction; ?>"><a title="" href="<?php echo $this->newsfeed->channel['link']; ?>" target="_blank"><?php echo str_replace('&apos;', "'", $this->newsfeed->channel['title']); ?></a></h2>
	...
	<?php foreach ($this->newsfeed->items as $item) :  ?>
		<li>
			<?php if (!is_null($item->get_link())) : ?>
				<a title=""  href="<?php echo $item->get_link(); ?>" target="_blank">
