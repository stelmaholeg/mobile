...
?>
    ...
    <form method="post" id="adminForm" name="userForm" class="form-validate" style="margin-top:15px;">
    <!--<form method="post" id="userForm" name="userForm" action="<?php echo JRoute::_('index.php'); ?>" class="form-validate">-->
	  ...
	  ?>
        <div class="control-buttons" style="margin:0 auto; width:250px; margin-top:20px;">
            <?php
...
// echo 'rview = '.$rview;
            ...
            if (VmConfig::get('oncheckout_show_register', 1) && $this->userId == 0 && $this->address_type == 'BT' and $rview == 'cart') {
                ...
                <?php if (!VmConfig::get('oncheckout_only_registered', 0)) { ?>
                    ...
                    <?php } ?>
                <button class="addtocart-button" type="reset" onclick="window.location.href='<?php echo JRoute::_('index.php?option=com_virtuemart&view=' . $rview); ?>'" ><?php echo JText::_('COM_VIRTUEMART_CANCEL'); ?></button>
                ...
                <button style="margin-left:20px;" class="addtocart-button" type="reset" onclick="window.location.href='<?php echo JRoute::_('index.php?option=com_virtuemart&view=' . $rview); ?>'" ><?php echo JText::_('COM_VIRTUEMART_CANCEL'); ?></button>
