...
// 	    $this->assignRef('productRelatedManufacturerList', $productRelatedManufacturerList);
	...
	public function getSearchCustom() {
		...
		$this->searchCustomList = JText::_('COM_VIRTUEMART_SET_PRODUCT_TYPE').'<br/>'.JHTML::_('select.genericlist',$this->options, 'custom_parent_id', 'class="inputbox"', 'virtuemart_custom_id', 'custom_title', $this->custom_parent_id);
